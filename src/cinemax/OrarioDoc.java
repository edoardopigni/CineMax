...
public class OrarioDoc implements Serializable {
	 ...
	 * attuale, cio� l'orario relativo all'istante in cui 
	 * viene invocato.
	 */
	public OrarioDoc() {
	...
	/**
	 * Imposta il separatore tra ore e minuti
	 * @param sep il carattere usato come separatore
	 */
	...
	/**
	 * Restituisce se il formato attivo è da 24 ore
	 * @return "TRUE" se il formato attivo è da 24 ore
	 */
	 ...
	 * il metodo � minore di quello fornito tramite il 
	 * parametro, il risultato sar� un numero positivo; 
	 * se invece � maggiore, il risultato sar� un numero 
	 * negativo.
	 * 
